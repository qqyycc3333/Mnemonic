...
system_gsm8k = (
    ...
    "At the end of the response you must provide your final answer in the format of 'Answer is'"
)
...
system_metamathqa = (
    "Below is a math question. "
    "Write a response that appropriately answers the question."
    "At the end of the response you must provide your final answer which should be an integer in the format of 'The answer is {answer}'."
)

system_medmcqa = (
    "The following prompt is a multiple-choice question about medicine."
    "You need to choose the correct one from the four options given and explain the reason."
    "At the beginning of the response you must provide your answer in the format of 'Answer is'"
    "Your answer should be a single word from the following list of options: ['A', 'B', 'C', 'D']."
    "Do not include any other text in your answer."
)

system_codetester = (
    "Write Python code to solve the task."
    "Your response is supposed to contain python code and explanation or analysis."
)
...
register_template(
    ...
    format_prefix=EmptyFormatter(slots=[{"bos_token"}]),
    stop_words=["<|eot_id|>", "<|eom_id|>"],
    default_system=system_alpaca,
)

register_template(
    name="llama3_metamathqa",
    format_user=StringFormatter(
        slots=[
            (
                "<|start_header_id|>user<|end_header_id|>\n\n{{content}}<|eot_id|>"
    ...
    format_prefix=EmptyFormatter(slots=[{"bos_token"}]),
    stop_words=["<|eot_id|>", "<|eom_id|>"],
    default_system=system_metamathqa,
)
...
register_template(
    ...
    format_prefix=EmptyFormatter(slots=[{"bos_token"}]),
    stop_words=["<|eot_id|>", "<|eom_id|>"],
    default_system=system_medmcqa,
)

register_template(
    name="llama3_codetester",
    format_user=StringFormatter(
        slots=[
            (
                "<|start_header_id|>user<|end_header_id|>\n\n{{content}}<|eot_id|>"
    ...
    format_prefix=EmptyFormatter(slots=[{"bos_token"}]),
    stop_words=["<|eot_id|>", "<|eom_id|>"],
    default_system=system_codetester,
)

register_template(
    name="qwen3_metamathqa",
    format_user=StringFormatter(slots=["<|im_start|>user\n{{content}}<|im_end|>\n<|im_start|>assistant\n"]),
    format_assistant=StringFormatter(slots=["{{content}}<|im_end|>\n"]),
    format_system=StringFormatter(slots=["<|im_start|>system\n{{content}}<|im_end|>\n"]),
    format_function=FunctionFormatter(slots=["{{content}}<|im_end|>\n"], tool_format="qwen"),
