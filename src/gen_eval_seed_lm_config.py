...
SAVE = "/data/oss_bucket_0/yuanyi/aaawin/saves/seed-lm"
# Configurations
...
# Experiment name
_run_name = rf"./scripts/eval_seed_lm/{_model_name}"
config_path = rf"./config/eval_seed_lm/{_model_name}"
...
with open(os.path.join(_run_name, "run_eval_seed_lm.sh"), 'w') as f:
    f.write(content_sh)
...
# hyperparameters sh
hyperparams_path = rf"{PATH}/saves/{_dataset}/{_model_name}/hyperparams"
content_hparams = rf"""
